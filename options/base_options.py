...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_name', type=str, default="meta", nargs='+')
        ...
        parser.add_argument('--model', type=str, default="metaisp")
        ...
        parser.add_argument('--fine_tune_warp',type=str2bool, default=False)
        
        # config net
        parser.add_argument('--pre_ispnet_coord', type=str2bool, default=False)
        parser.add_argument('--attention',type=str, default="adaquery")
        parser.add_argument('--attention_match',type=str, default="prod")
        parser.add_argument('--positional',type=str2bool, default=True)
        parser.add_argument('--multi_device',type=str2bool, default=True)
        parser.add_argument('--depth',type=int, default=1)
        parser.add_argument('--infedev',type=int, default=0)
        parser.add_argument('--query_emb',type=str2bool, default=True)
        parser.add_argument('--illuminant',type=str2bool, default=False)
        parser.add_argument('--iso_exp',type=str2bool, default=True)
        parser.add_argument('--wc',type=float, default=0.1)

        parser.add_argument('--individual',type=str2bool, default=False)
        parser.add_argument('--single_image', type=str2bool, default=False, help='single image flag')
        
        # test
        parser.add_argument('--inference',type=str2bool, default=False)
        parser.add_argument('--full',type=str2bool, default=False)
        parser.add_argument('--latent', type=str2bool, default=False, help='interpolate devices')
        parser.add_argument('--latent_n',type=int, default=5, help='number of intermidiate images in between devices')
        ...
        parser.add_argument('--lr_policy', type=str, default='tozero')
