...
class GaussianLoss(torch.nn.Module):
    ...
    def forward(self, img1=None, img2=None):
        ...
        img1 = F.interpolate(img1,scale_factor=float(1/self.scale),mode='bilinear',antialias=True)
        img1 = F.interpolate(img1,scale_factor=self.scale,mode='bilinear',antialias=True)

        img2 = F.interpolate(img2,scale_factor=float(1/self.scale),mode='bilinear',antialias=True)
        img2 = F.interpolate(img2,scale_factor=self.scale,mode='bilinear',antialias=True)

        return self.L1_loss(img1,img2)
